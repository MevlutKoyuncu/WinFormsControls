...
{
    public partial class DateTimeControls : Form
    {
        ...
        private void btn_tarihgetir_Click(object sender, EventArgs e)
        {
            ...
            lbl_ekran.Text = secilen.ToString();
            lbl_kisatarih.Text = secilen.ToLongDateString();
            lbl_uzuntarih.Text = secilen.ToShortDateString();
        ...
        private void btn_aralikgetir_Click(object sender, EventArgs e)
        {
